...
export default function AdLauncherPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="glass-strong px-8 pt-7 pb-6">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="ml-auto flex items-center gap-2 rounded-full glass-pill p-1.5">
            <span className="text-xs text-muted-foreground pl-3">Klant</span>
            <Select
              value={selectedId}
              onValueChange={(v) => setSearchParams(v ? { client: v } : {})}
            >
              <SelectTrigger className="w-[220px] h-9 rounded-full border-0 glass text-sm">
